...
namespace Skillz.Data.Migrations
{
    ...
    [Migration("20200708121445_bdatenullabla")]
    partial class bdatenullabla
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Skillz.Models.Entities.Note", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Skillz.Models.Entities.Note", b =>
                {
                    b.HasOne("Skillz.Models.Consultants.Consultant", null)
                        .WithMany("Notes")
                        .HasForeignKey("ConsultantId");
                });
